...
const dict = {
  tr: {
    ...
    turkerler: {
      ...
      healthcareAi: "İşBank IsCep (Global Finance En İyi Mobil Bankacılık), Burgan Bank ON, DenizBank, Pegasus Airlines, Turkcell, Unilever Türkiye, MetLife, Air Astana, Turkish Airlines, eBay, CCI (Coca-Cola İçecek), Garanti BBVA, Marketyo. Commencis LLM ile Türkçe odaklı bankacılık AI'ı, Dataroid ile müşteri analitiği, Commence Bot ile conversational AI.",
  ...
  en: {
    ...
    turkerler: {
      ...
      healthcareAi: "IsBank IsCep (Global Finance Best Mobile Banking), Burgan Bank ON, DenizBank, Pegasus Airlines, Turkcell, Unilever Turkey, MetLife, Air Astana, Turkish Airlines, eBay, CCI (Coca-Cola Icecek), Garanti BBVA, Marketyo. Turkish-focused banking AI with Commencis LLM, customer analytics with Dataroid, conversational AI with Commence Bot.",
