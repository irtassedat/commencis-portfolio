...
const dict = {
  tr: {
    ...
    about: {
      ...
      bio1: "Endüstri mühendisliği altyapım ile full-stack yazılım ve AI teknolojilerini birleştiriyorum. Veri analitiği, süreç optimizasyonu ve otonom sistem tasarımı konusundaki mühendislik perspektifimi React/Next.js, Node.js ve modern AI araçlarıyla üretime taşıyorum. Commencis'in dijital dönüşüm vizyonuna ",
  ...
  en: {
    ...
    about: {
      ...
      bio1: "I combine an industrial engineering foundation with full-stack development and AI technologies. I bring an engineering perspective in data analytics, process optimization, and autonomous system design to production with React/Next.js, Node.js, and modern AI tools. I can contribute to Commencis's digital transformation vision through ",
